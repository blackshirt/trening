...
func (q *queryResolver) OrgList(ctx context.Context) ([]models.Organisasi, error) {
...
func (t *trainingResolver) Organizer(ctx context.Context, obj *models.Training) (models.Organisasi, error) {
...
func (t *trainingResolver)	Location(ctx context.Context, obj *models.Training) (models.Organisasi, error) {
